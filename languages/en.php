...
$lang["INFO"] = "The History of Khorinis is an addon to the popular game Gothic, introductory a new history placed in the tumultuous times before the creation of the Magic Barrier — over ten years before events from the first and the second part of saga. Publication of the project is planned in two parts — at first on the new island Vaduz and next on Khorinis Island.";
$lang["INTRO_T"] = "Intro";
...
$lang["FEATURES_12"] = "Hugh number of new PFX";
...
$lang["TEAM_REC_1"] = "Despite advanced stage of our work on the project, we are still opened for fresh people — now especially 3D and 2D graphic designers, coders, professional actors, and also level designers working in program ‘Spacer’.";
...
$lang["ADBLOCK_WARNING_1"] = "There are no ads on site, but some of Adblock software block our photos, videos and other important things you should see to become fully familiar with the History of Khorinis.";
