<?php
  ...
  $lang['TITLE'] 		= 'The History of Khorinis';
  $lang['SITE_URL']		= "thehistoryofkhorinis.com";
  $lang['SITE_EMAIL']	= "contact@thehistoryofkhorinis.com";
  $lang['HELLO'] 		= 'Welcome to the official website of the History of Khorinis addon';
  
  $lang['LOGO'] = 'company_en.png';
  
  $lang['INFO'] = 'The History of Khorinis is the addon to the popular game Gothic, introductory a new history placed in the tumultuous times before the creation of the Magic Barrier – over ten years before events from the first and the second part of saga. Publication of the projects is planned in two parts - at first on the new island Vaduz and next on Khorinis Island';
  
  $lang['INTRO_T'] = 'Intro';
  $lang['INTRO']   = 'The action of the History of Khorinis is situated on Vaduz Island, which is a part of the Kingdom of Myrthana, being an important centre of trade, extraction and argriculture. On Vaduz we can find the huge town, many farms, mines, taverns,  competitive merchant guilds, the Monastery of Adanos and so other interesting places, waiting for discovery. In the game we have an opportunity to play as Lars, whose life changes drastically as a result of a mysterious intrigue. A player will make a decision to which influential guild will join, deciding on his fate and his enemies.  During the game, we will meet many characters from the world of Gothic and we will meet their history prior to the creation of the Barrier.';
  
  $lang['FEATURES_T']  = 'Features';
  $lang['FEATURES_1']  = 'The world\'s first fan project with professional dubbing!';
  $lang['FEATURES_2']  = 'Vaduz Island  - brand new world much bigger than the ones from previous versions!';
  $lang['FEATURES_3']  = 'Khorinis, The Valley of Mines and the Old Mine as you have never seen before!';
  $lang['FEATURES_4']  = 'Attention to the compliance with the story of the saga';
  ...
  $lang['DOWNLOAD']   = 'Here you will find download link to the addon on its release day.';
  
  $lang['GALLERY_T']    = 'Gallery'; 
  $lang['RELEASE_DATE'] = 'Our addon is in the condition of putting all elements together – we are rewriting scripts into game code, placing the characters to the finished world and adding the voice-overs instantly on the same stage. We do not throw any release dates, because we do not know it will last two months, or eight.  There are approximated data, but there are many things, which are impossible to estimate. We are working hard, polishing every details and there are 50 actors left to prepare voice-overs.  We are arranging with the recording studios – which are help us in our project for free - individually.'; 
  
  $lang['TOP'] = 'To top'; 
  
  $lang['FORUM'] = 'Forum';
  
  $lang['PRESS_PACK'] = 'Download presspack'; 
  
  $lang['NEWSLETTER_TEXT']   = 'Subscribe to newsletter!';
  $lang['NEWSLETTER_EMAIL']  = 'email adress';
  $lang['NEWSLETTER_BUTTON'] = 'Send';
